    ...
    <div class="container p-4">
        ...
        <div class="card p-4 mb-4">
            <div class="row justify-content-center align-items-end text-center">
                ...
                <!-- Rank 2 -->
                <div class="col-lg-4 col-md-4 col-4 d-flex flex-column align-items-center" style="margin-top:40px; width:250px;">
                    @php
                        $user = $top3[1] ?? null;
                        $rank = 2;
                        $trophyColor = 'silver';
                ...
                <!-- Rank 1 -->
                <div class="col-lg-4 col-md-4 col-4 d-flex flex-column align-items-center" style="margin-top:0px;  width:250px;">
                    @php
                        $user = $top3[0];
                        $rank = 1;
                        $trophyColor = 'gold';
